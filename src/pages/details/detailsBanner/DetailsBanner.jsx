                                                        ...
                                                        <span className="text">
                                                            {
                                                                director?.map((item, index) => (
                                                                    <span key={index}>{item.name}{director?.length - 1 !== index && ", "}</span>
                                                                ))
                                                            }
                                                        </span>
                                                    </div>
                                                        ...
                                                        <span className="text">
                                                            {
                                                                writer?.map((item, index) => (
                                                                    <span key={index}>{item.name}{writer?.length - 1 !== index && ", "}</span>
                                                                ))
                                                            }
                                                        </span>
                                                    </div>
                                                        ...
                                                        <span className="text">
                                                            {
                                                                data.created_by?.map((item, index) => (
                                                                    <span key={index}>{item.name}{data.created_by?.length - 1 !== index && ", "}</span>
                                                                ))
                                                            }
                                                        </span>
                                                    </div>
